    ...
    <>
      ...
      <Wrapper>
        ...
        <p className='xtext-justify'>
          This Privacy Policy outlines what information is collected through the Digital Assets and how that information is used. Smart Kidz Club, Inc. ("<b>Owner</b>") owns and operates the Digital Assets. Owner will only keep users' or viewers' of the Digital Assets (collectively, "Users" and each a "User") information, which they submit through the Digital Assets, for its own internal use.
        </p>
        ...
        <div className='terms'>
          <div className='qu-blu'>Commercial Digital Assets</div>
          <p className='xtext-justify'>
